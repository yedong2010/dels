...
class Mysql(object):
    ...
    def __getConn():
        ...
        if Mysql.__pool is None:
            __pool = PooledDB(creator=pymysql, mincached=10, maxcached=50,
                              host=Config.DB_HOST, port=Config.DB_PORT, user=Config.DB_USER, passwd=Config.DB_PASSWORD,
                              db=Config.DB_DBNAME, use_unicode=False, charset=Config.DB_CHARSET, cursorclass=DictCursor)
