...
<div class="site-wrapper" ng-controller="DelsCtrl">
    <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
            <div class="mastfoot">
                <div class="inner">
                    <p>11年入A站，很少评论，很怀恋2年前的delete-so，临时起意想要做个简单版的delete-so，所以加了个mini,
                        前后也拖沓了个把月，很感谢delete-so作者的同意，部分代码参考delete-so的开源代码,
                        大家低调使用, 说不定哪天就被封了。技术有限，就不要喷我了。 by May-to-Marry.</p>
                </div>
            </div>
        </div>
    </div>
