 ...
 * @date 2017-03-15
 */
app.controller('analysisBusTimeCtrl', ['$scope', '$state', 'commonService', '$sce', '$stateParams', function ($scope, $state, commonService, $sce, $stateParams) {
    /**
    ...
    $scope.queryData = function () {
        commonService.queryDataByP('analysis/analysisBusTime',{
