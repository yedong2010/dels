 ...
 * @date 2017-03-16
 */
app.controller('dataProcessCtrl', ['$scope', '$state', 'commonService', '$sce', '$stateParams', function ($scope, $state, commonService, $sce, $stateParams) {
    /**
    ...
    $scope.queryData = function () {
        commonService.queryDataByP('quality/dataProcess',{
