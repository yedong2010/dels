 ...
 * @date 2017-03-15
 */
app.controller('dataAbnormalCtrl', ['$scope', '$state', 'commonService', '$sce', '$stateParams', function ($scope, $state, commonService, $sce, $stateParams) {
    /**
    ...
    $scope.queryData = function () {
        commonService.queryDataByP('rate/dataAbnormal',{
