    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            one: {
                ...
                src: ['<%= dirs.src %>/**.js', '<%= dirs.src %>/*/**.js', '<%= dirs.src %>/ctrl/index/**.js'],
                dest: '<%= dirs.dest %>/<%= pkg.name %>.js'
            },
            two: {
                src: ['<%= vendor.src %>/html5shiv.min.js', '<%= vendor.src %>/jquery/jquery-1.11.1.min.js', '<%= vendor.src %>/adminLTEApp.js', '<%= vendor.src %>/bootstrap/js/bootstrap.js', '<%= vendor.src %>/angular/angular.min.js', '<%= vendor.src %>/bootstrap/js/bootstrap-datetimepicker.min.js', '<%= vendor.src %>/bootstrap/js/bootstrap-datetimepicker.zh-CN.js', '<%= vendor.src %>/angular/ui-bootstrap-tpls.min.js', '<%= vendor.src %>/angular/angular-ui-router.min.js', '<%= vendor.src %>/highcharts.js', '<%= vendor.src %>/highcharts-3d.js', '<%= vendor.src %>/highcharts-more.js', '<%= vendor.src %>/angular/highcharts-ng.min.js', '<%= vendor.src %>/underscore-min.js', '<%= vendor.src %>/angular/angular-toastr.tpls.min.js', '<%= vendor.src %>/angular/angular-animate.min.js','<%= vendor.src %>/textAngular/textAngular-rangy.min.js','<%= vendor.src %>/textAngular/textAngular-sanitize.min.js','<%= vendor.src %>/textAngular/textAngular.min.js'],
